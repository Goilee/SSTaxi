        ...
        if tiles[crossCoords[0]][crossCoords[1]][0] == '4way':
            ...
            for i in range(4):
                ...
                if tiles[crossCoords[0] + dCoords[0]][crossCoords[1] + dCoords[1]] != -1:
                    ...
                    print(tiles[crossCoords[0]][crossCoords[1]][1], tiles[coords[0]][coords[1]][1], [[dCoords[1], dCoords[0] * -1], direction])
                    parse(coords, graph)
...
if __name__ == "__main__":
    print(parseYAML2GRAPH('../../map.yaml').edges[1, 2, 1])
